        ...
        <div class="py-12 px-6 h-full flex flex-col gap-6">
            ...
            @if ($reviews->count() > 0)
                <div id="reviews-container"
                    ...
                    @include('cabinet.partials.review-cards', ['reviews' => $reviews])
                </div>
            ...
            @else
                <div class="flex flex-col items-center justify-center h-full text-center py-20">
                    ...
                    <h3 class="text-xl font-semibold text-gray-600 mb-2">У вас пока нет отзывов</h3>
                    <p class="text-gray-500 mb-6">Начните оставлять отзывы о застройщиках и комплексах</p>
                    <a href="{{ route('home') }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (loadMoreBtn) {
                loadMoreBtn.addEventListener('click', function() {
                    ...
                    let url = `/my-reviews/${userId}?page=${nextPage}`;
                    if (filter) {
                        url += `&filter=${filter}`;
                    }
