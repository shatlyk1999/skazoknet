...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('admin/compiled/css/error.css') }}" />
</head>
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ asset('admin/compiled/svg/error-403.svg') }}" alt="Not Found">
                    <h1 class="error-title">Запрещено</h1>
                    <p class="fs-5 text-gray-600">У вас нет прав для просмотра этой страницы.</p>
