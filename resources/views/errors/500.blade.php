        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ asset('admin/compiled/svg/error-500.svg') }}" alt="Not Found">
                    <h1 class="error-title">Системная ошибка</h1>
                    <p class="fs-5 text-gray-600">Вебсайт в настоящее время недоступен. Попробуйте позже или свяжитесь с
                        разработчиком.</p>
